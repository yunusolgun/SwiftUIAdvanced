...
let collosseumLandmark = Landmark(id: 1, name: "Colloseum", imageName: "colosseum", country: "Italy", category: "Historic Area", coordinates: Coordinates(latitude: 41.8902102, longitude: 12.4900422))
...
let greatWallLandmark = Landmark(id: 4, name: "Great Wall", imageName: "greatwall", country: "China", category: "Wall", coordinates: Coordinates(latitude: -33.8567844, longitude: 151.213108))


let landmarkArray = [eiffelLandmark, collosseumLandmark,londonBridgeLandmark,pisaLandmark,greatWallLandmark]
